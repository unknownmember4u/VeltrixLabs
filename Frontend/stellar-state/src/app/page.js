...
const GlassCard = ({ children, className = "", borderAccent = "" }) => (
  <div className={`
    ...
    hover:border-[#00a8e8]/50 transition-all duration-300
...
export default function ZenOLandingPage() {
  return (
    <>
      ...
      <div className="relative min-h-screen text-[#00171f] selection:bg-[#00a8e8]/30" style={{ zIndex: 1 }}>
        ...
        <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-[#faf9f6]/70 border-b border-[#003459]/10">
          <div className="px-6 lg:px-12 h-16 flex items-center justify-between">
            <div className="text-2xl font-bold text-[#00a8e8] tracking-tighter">
              Zen-O
            </div>
        ...
        <main>
          ...
          <section className="relative min-h-screen flex flex-col items-center justify-center py-20 px-6 max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-[#00171f]/70 max-w-3xl mb-12">
              ...
              <span className="text-[#00a8e8] font-semibold">Zen-O isko badalta hai</span> — real-time AI-powered factory orchestration, sirf ₹12,400/month mein.
            </p>

            <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
              <a href="#features" className="px-8 py-4 bg-[#00a8e8] hover:bg-[#007ea7] text-white font-semibold rounded-xl transition-all duration-200 w-full sm:w-auto text-center shadow-[0_10px_25px_rgba(0,168,232,0.25)]">
                See How It Works
              </a>
              <a href="https://github.com" className="px-8 py-4 border border-[#003459]/10 hover:border-[#00a8e8]/50 text-[#00171f] font-semibold rounded-xl transition-all duration-200 w-full sm:w-auto bg-white/50 backdrop-blur-sm text-center">
                View on GitHub
              </a>
            </div>
          ...
          <section className="py-20 px-6 max-w-7xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-[#00a8e8]">We Eliminated the API Layer Entirely</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              {/* Zen-O */}
              <GlassCard borderAccent="border-[#00a8e8]/30 bg-[#00a8e8]/[0.02] shadow-[0_10px_40px_rgba(0,52,89,0.05)]">
                <div className="flex justify-between items-center mb-6">
                  <span className="text-[#00a8e8] font-mono text-sm">Zen-O</span>
                  <span className="text-[#00a8e8] text-sm font-bold">&lt; 5ms</span>
                </div>
                <div className="flex flex-col gap-4 items-center h-full justify-center">
                  <div className="w-full p-4 bg-white border border-[#00a8e8]/30 rounded-lg text-center font-bold text-[#00171f] shadow-sm">Sensor</div>
                  <div className="animate-bounce text-[#00a8e8] text-center text-xl font-bold">↓</div>
                  <div className="w-full p-6 bg-[#00a8e8] text-white rounded-xl text-center font-bold shadow-[0_8px_25px_rgba(0,168,232,0.3)]">
                    SpacetimeDB Reducer
                  </div>
                  <div className="flex justify-between w-full mt-4">
                    {["Client A", "Client B", "Client C"].map((client) => (
                      <div key={client} className="flex-1 px-2 py-2 bg-white border border-[#00a8e8]/20 rounded mx-1 text-center text-[10px] md:text-xs text-[#00a8e8] font-bold shadow-sm">
                        {client}
                      </div>
                    ))}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <GlassCard key={i} className="bg-white">
                  <div className="text-[#00a8e8] font-mono text-sm mb-3 font-bold">{f.n}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <GlassCard key={i} className="flex flex-col h-full bg-white">
                  <span className="text-[#007ea7] text-xs font-bold uppercase tracking-widest mb-2">{a.label}</span>
          ...
          <section id="pricing" className="py-20 px-6 max-w-7xl mx-auto scroll-mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <GlassCard borderAccent="border-[#00a8e8]/50 bg-white shadow-[0_15px_45px_rgb(0,52,89,0.06)]">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-[#00171f] mb-2">Zen-O</h3>
                    <div className="text-[#00a8e8] font-bold text-4xl">₹12,400<span className="text-sm font-normal text-[#00171f]/40">/month</span></div>
                  </div>
                  <span className="bg-[#00a8e8] text-white text-[10px] uppercase font-bold px-3 py-1 rounded-full shadow-lg shadow-[#00a8e8]/20">Recommended</span>
                </div>
                <ul className="space-y-4 mb-8">
                  {["₹0 setup (MIT open-source)", "Commodity hardware (PC/NUC)", "Full ownership of data", "100% On-premises security"].map((item) => (
                    <li key={item} className="flex items-center gap-3 text-[#00171f]/80 text-sm md:text-base font-medium">
                      <span className="text-[#00a8e8] font-bold text-lg">✓</span> {item}
                    </li>
                  ))}
                </ul>
              </GlassCard>
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4">
              ...
              <div className="px-3 py-2 bg-[#00a8e8]/10 border border-[#00a8e8]/30 rounded-lg text-[#00a8e8] text-[10px] md:text-xs font-bold shadow-sm">
                Total: $149/mo
              </div>
            </div>
          </section>
          ...
          <section className="py-20 px-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <div key={i} className="group px-6 py-3 bg-white border border-[#003459]/10 rounded-2xl hover:border-[#00a8e8]/50 hover:shadow-md transition-all cursor-default shadow-sm active:scale-95">
                  <div className="text-[#00171f] font-bold group-hover:text-[#00a8e8] transition-colors">{tech.n}</div>
        ...
        <footer className="py-20 border-t border-[#003459]/10 bg-[#faf9f6]/80 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-6 text-left">
            <div className="text-3xl font-bold text-[#00a8e8] mb-4 tracking-tighter">Zen-O</div>
            <p className="text-[#00171f]/60 mb-8 max-w-md text-sm">Zero-Latency Edge Orchestrator | HackByte 4.0</p>
            <div className="h-px w-24 bg-[#00a8e8]/30 mb-8"></div>
